...
public class board
{
	...
	private static int width = Frame.getScreenWidth()/Game.getWidth(); 
	private static int height = Frame.getScreenHeight()/Game.getHeight(); 
	
	public board(int x, int y, BufferedImage normal, BufferedImage bomb, BufferedImage openedImage, BufferedImage flag)
	{
		this.x = x;
		this.y = y;
		this.normal = normal;
